...
export default function YoutubeScreen() {
  ...
  const { data, isLoading, isError, refetch } = useQuery({
    queryKey: ['contents', { source_type: 'youtube', q: submittedQuery, tags: combinedTags, page: 1 }],
    queryFn: () => getContents({ source_type: 'youtube', q: submittedQuery || undefined, tags: combinedTags, page: 1, limit: 20 }),
  });
  ...
  const loadMore = useCallback(async () => {
    ...
    try {
      ...
      const result = await getContents({ source_type: 'youtube', q: submittedQuery || undefined, tags: combinedTags, page: nextPage, limit: 20 });
